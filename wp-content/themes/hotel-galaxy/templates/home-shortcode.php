				...
				<div class="section-title animate fadeInLeft" style="margin: 0;">
					<h1 class="heading head-m feature-title">
						...
						if($hotel_galaxy_settings['shortcode_title']){
							echo esc_attr($hotel_galaxy_settings['shortcode_title']);
						}else{
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3 hotel-g-contact-form">
				...
				if($hotel_galaxy_settings['shortcode_echo']!=''){
					...
					?>
					<div class="caption">
						<p class="description text-center"><?php echo _e('Contact Form 7 Shortcode Paste Here.','hotel-galaxy'); ?></p>	
						<p class="description text-center"><?php echo _e('1.  Go to Customizer ->Shortcode Section','hotel-galaxy'); ?></p>	
					</div>
					<?php
				}
