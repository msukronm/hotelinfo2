				...
				<div class="section-title animate fadeInRight" style="margin-bottom: 30px;">
					<h1 class="heading head-m feature-title" style="color:<?php echo esc_attr($hotel_galaxy_settings['room_sec_titleColor']) ?>">
						...
						if($hotel_galaxy_settings['room_sec_title']){
							echo esc_attr($hotel_galaxy_settings['room_sec_title']);
						}else{
					...
					<div class="col-small room-item col-xs-12 col-sm-6 col-md-6 col-lg-4">
						<div class="thumbnail">
							...
							if(has_post_thumbnail()){
								...
								?>
								<a href="<?php the_permalink(); ?>">
									<img src="<?php echo esc_url(Hotel_galaxy_Template_Dir_Uri.'/images/no-image.png'); ?>" alt="<?php the_title(); ?>" class="img-responsive">
								</a>
								<?php
							} 
							?>
